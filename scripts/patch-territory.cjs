...
if (!source.includes('AMAZONAS_MUNICIPALITIES')) {
...
const replacement = [
  ...
  '    </div>',
  '    {municipality !== "Manaus" && <div className="territory-note">Para municípios do interior, o campo utiliza a categoria <b>Bairro / localidade</b>. Quando não houver uma lista municipal validada, o sistema não inventa denominações.</div>}',
  '  </>;',
  '}',
  '',
